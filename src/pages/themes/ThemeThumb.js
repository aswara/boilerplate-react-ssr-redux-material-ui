              ...
              if (index === 1) {
                return (
                  <li key={index.toString()}>
                    ...
                    <p className={classes.stick} style={{ background: themePalette[props.value].palette.secondary.main }} />
                  </li>
                );
              }
              return (
                <li key={index.toString()}><i style={{ background: themePalette[props.value].palette.secondary.main }} /><p className={classes.stick} /></li>
              );
            })}
          </ul>
        </aside>
